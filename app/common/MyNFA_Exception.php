<?php
	...
	if ( ! class_exists( 'MyNFA_Exception' ) ) {
		class MyNFA_Exception extends \Exception {
			
			private $severity, $severity_arr;
			...
			private static function create_debug_file() {
				$path = MyNFA__PLUGIN_NAME__PLUGIN_PATH . DIRECTORY_SEPARATOR . 'debugging' . DIRECTORY_SEPARATOR . self::getFileName();
